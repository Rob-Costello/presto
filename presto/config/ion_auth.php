...
*/
$config['tables']['users']           = 'presto_users';
$config['tables']['groups']          = 'presto_groups';
$config['tables']['users_groups']    = 'presto_users_groups';
$config['tables']['login_attempts']  = 'presto_login_attempts';
 ...
 */
$config['site_title']                 = "Plastic Card Factory";       // Site Title, example.com
$config['admin_email']                = "paul@stickymedia.co"; // Admin Email, admin@example.com
$config['default_group']              = 'Sales Advisor';           // Default group, use name
