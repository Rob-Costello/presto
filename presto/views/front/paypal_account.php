...
<section id="main-header" class="row">
	...
	<div class="small-12 medium-6 medium-offset-3 columns">
		<form method="post" action="/rt/" data-abide novalidate>
			...
			<p>Please provide your PayPal account email, so we can pay you the reward:</p>
      <div class="columns small-12">
			   <input type="email" name="paypal_email" placeholder="PayPal Email" required>
         <span class="form-error">This field is required.</span>
      </div>
      <input type="hidden" name="action" value="paypal account">
      ...
      <input type="hidden" name="proceed_option" value="<?php echo $proceed_option; ?>">
			<button type="Submit" class="button" class="first">Submit</button>
