...
<section id="main-header" class="row">
	...
	<div class="small-12 medium-6 medium-offset-3 columns">
		<form method="post" action="/rt/" data-abide novalidate>
			...
			<p>To activate this reward tag please complete the following:</p>
			<div class="columns small-12">
        <input type="text" name="description" placeholder="Description" required>
        <span class="form-error">This field is required.</span>
      </div>
      <div class="columns small-12">
        <input type="number" name="reward" placeholder="Reward" required>
        <span class="form-error">This field is required.</span>
      </div>
      <input type="hidden" name="tag" value="<?php echo $tag; ?>">
			<button type="Submit" class="button">Submit</a>
