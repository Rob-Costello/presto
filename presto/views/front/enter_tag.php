...
<section id="main-header" class="row">
	...
	<div class="small-12 medium-6 medium-offset-3 columns">
		<form method="post" action="/rt/">
			...
			<p>Please enter a Reward Tag number:</p>
			<input type="text" name="tag" placeholder="ABC123">
      <?php if( $errors != '' ){ ?>
        <div class="g-recaptcha" data-sitekey="6LfVrxoUAAAAABsJi2253XYvmvMqTdLAqCRq5YIA"></div>
			<?php } ?>
